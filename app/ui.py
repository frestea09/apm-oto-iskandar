...
class PatientApp:
    ...
    def _prompt_admin_login(self) -> bool:
        ...
        submit_button = tk.Button(button_frame, text="Masuk", command=submit, width=12)
        submit_button.pack(side=tk.LEFT, padx=6)

        close_button = tk.Button(button_frame, text="Batal", command=dialog.destroy, width=12)
    ...
    def _open_config_dialog(self):
        if not self._prompt_admin_login():
            return
